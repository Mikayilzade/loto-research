...
| H5 | CLOSED | nonlinear portfolio / pricing / promotion overlay screen | — | `research/h005_nonlinear_overlay_screen.md` |
...
| H11 | CLOSED | lawful visible pre-purchase information leakage | — | `research/h011_visible_prepurchase_information.md` |
...
| H18 | CLOSED | Virginia Lucky Contestant hidden daily time-state | — | `research/h018_lucky_contestant_time_state.md` |
...
| H25 | CLOSED | The Health Lottery full-space coverage | 100% | `research/h025_health_lottery_full_coverage.md` |
| H26 | CLOSED | Millionaire for Life full-space coverage | 100% | `research/h026_millionaire_for_life_full_coverage.md` |
| H27 | CLOSED | Lotto America full-space coverage | 85.2098% | `research/h027_lotto_america_full_coverage.md` |
| H28 | CLOSED | Nebraska finite-game full-coverage screen | 58.4723% | `research/h028_nebraska_finite_coverage.md` |
| H29 | CLOSED | fixed-odds digit games: additive-portfolio impossibility | 57.8% | `research/h029_fixed_digit_games_impossibility.md` |
| H30 | CLOSED | Virginia Cash 5 with EZ Match | — | `research/h030_virginia_cash5_ezmatch.md` |
| H31 | CLOSED | Cash Pop Cover All guarantee screen | 33.3333% | `research/h031_cash_pop_cover_all.md` |
| H32 | CLOSED | Canada DAILY GRAND full-space / compact fixed-payout screen | 44.3472% | `research/h032_canada_daily_grand_compact_screen.md` |
| H33 | CLOSED | New Zealand Bullseye discounted multi-draw full coverage | — | `research/h033_nz_bullseye_discounted_coverage.md` |
| H34 | CLOSED | Ontario DAILY KENO fixed-payout coverage | 42.03% | `research/h034_ontario_daily_keno_full_coverage.md` |
| H35 | CLOSED | Lotterywest compact fixed-odds games: Super66 + Cash 3 | 54.35% | `research/h035_lotterywest_compact_games.md` |
...
| H111 | CLOSED | Texas scratch fixed-pack guarantee + retailer-commission overlay | 100% | `research/h111_texas_scratch_pack_commission_floor.md` |
| H112 | CLOSED | cross-jurisdiction fixed-pack / high-payout instant-ticket screen | 82% | `research/h112_cross_jurisdiction_fixed_pack_screen.md` |
| H113 | OPEN | Azerbaijan 4+4 statutory carryover hurdle | — | `research/h113_4plus4_statutory_carryover_hurdle.md` |
| H114 | CLOSED | Azerbaijan TezLoto exact dynamic-odds screen | — | `research/h114_tezloto_dynamic_odds_exact_screen.md` |
| H115 | OPEN | Azerbaijan 4+4 one-step zero-category carryover bound | — | `research/h115_4plus4_one_step_carryover_bound.md` |
| H116 | CLOSED | Azerbaijan 4+4 exceptional multi-zero carryover bound | — | `research/h116_4plus4_exceptional_multizero_bound.md` |
| H117 | CLOSED | Poland Multi Multi recurring +50% promotion full-space bound | 100% | `research/h117_poland_multimulti_50pct_promo_fullspace.md` |
| H118 | CLOSED | current capped charity/hospital raffle takeover screen | 100% | `research/h118_current_capped_charity_raffle_takeover.md` |
...
| H122 | CLOSED | Florida Millionaire Raffle 2026 undersubscription overlay | 57.045% | `research/h122_florida_millionaire_raffle_undersubscription_overlay.md` |
...
| H127 | OPEN | Pennsylvania Millionaire Raffle weekly-cohort overlay | 62.2042% | `research/h127_pennsylvania_weekly_cohort_overlay.md` |
...
| H137 | CLOSED | Kentucky stacked referral + 100% first-deposit match + Pick 3 Pair cover | 60% | `research/h137_kentucky_stacked_referral_match_pair_cover.md` |
| H138 | CLOSED | cross-state >=100% lottery-bonus + compact fixed-prize coverage screen | 100% | `research/h138_cross_state_100pct_bonus_compact_cover_screen.md` |
...
| H144 | CLOSED | Nebraska municipal Keno special-paytable / free-play route | 100% | `research/h144_nebraska_municipal_keno_special_paytable_route.md` |
...
| H147 | CLOSED | Nebraska rollback execution + current special surface | 62.5% | `research/h147_nebraska_rollback_execution_and_current_special_surface.md` |
| H148 | CLOSED | Omaha August 2026 $2 Monthly Special: exact 3-Spot full-cover test | 70.7644% | `research/h148_omaha_august_2026_3spot_special_full_cover.md` |
| H149 | UNCLASSIFIED | Nebraska Keno general full-paytable deterministic screen | — | `research/h149_nebraska_keno_general_full_paytable_theorem.md` |
| H150 | CLOSED | Missouri Club Keno marked-ball full-cover theorem | 31.2196% | `research/h150_missouri_club_keno_marked_ball_cover.md` |
| H151 | CLOSED | La Vista Quarter Madness deterministic full-cover screen | 81.0636% | `research/h151_lavista_quarter_madness_full_cover.md` |
| H152 | CLOSED | Nebraska Quarter Mania cross-city screen + La Vista subsidy check | 78.6624% | `research/h152_nebraska_quarter_crosscity_and_lavista_subsidy.md` |
| H153 | CLOSED | State-lottery Keno cross-jurisdiction deterministic-cover screen | — | `research/h153_state_lottery_keno_crossjurisdiction_screen.md` |
| H154 | CLOSED | KenoGO Jackpot hidden-state deterministic-cover screen | 125% | `research/h154_kenogo_jackpot_hidden_state_cover.md` |
| H155 | CLOSED | pre-announced Keno boost / multiplier timing screen | 100% | `research/h155_preannounced_keno_boost_screen.md` |
| H156 | CLOSED | universal Keno doubler vs paid-add-on screen | 66.1392% | `research/h156_universal_keno_doubler_paid_addon_screen.md` |
| H157 | CLOSED | BCLC Keno Value Bundle deterministic subsidy threshold | 100% | `research/h157_bclc_keno_value_bundle_threshold.md` |
| H158 | CLOSED | Emirates Draw deterministic cart promotions + SURE residual-takeover screen | 75% | `research/h158_emirates_draw_deterministic_promos_and_sure_residual_takeover.md` |
| H159 | CLOSED | fixed-board raffle residual takeover: forced-slot worst-case floor | 100% | `research/h159_residual_raffle_forced_slot_floor.md` |
| H160 | CLOSED | Michigan Red Ball Double Draw: forced-state deterministic coverage | 100% | `research/h160_michigan_red_ball_forced_double_draw_cover.md` |
...
| H164 | CLOSED | North Carolina Pick 3 forced Double Draw + retailer commission overlay | 107% | `research/h164_nc_pick3_double_draw_retailer_overlay.md` |
| H165 | CLOSED | NC retailer self-play legality + 2026 tax-floor stress test | 90% | `research/h165_nc_retailer_self_play_tax_gate.md` |
| H166 | CLOSED | NC Pick 3 forced Double Draw: corporate tax salvage + liability-limit stress | 23% | `research/h166_nc_double_draw_corp_tax_and_liability.md` |
| H167 | CLOSED | NC retailer-authorized discount + forced Pick 3 Double Draw | 21% | `research/h167_nc_retail_discount_double_draw.md` |
| H168 | CLOSED | NC Pick 3 retailer discount authority + current Double Draw availability | — | `research/h168_nc_pick3_discount_authority_and_current_availability.md` |
...
| H176 | OPEN | Rhode Island Keno live execution surface and current-promotion gate | — | `research/h176_ri_keno_live_execution_surface_2026.md` |
...
| H181 | CLOSED | Michigan Club Keno Tripler Time pre-draw overlay | 195.642% | `research/h181_michigan_tripler_time_prelocked_overlay.md` |
...
| H186 | OPEN | H185 mass counterexample packet | — | `research/h186_h185_mass_counterexample_packet.md` |
| H187 | CLOSED | H180 support-(2,3,4) coefficient normalization | — | `research/h187_h180_support4_coefficient_normalization.md` |
| H188 | CLOSED | H180 B/C shift normalization | — | `research/h188_h180_bc_shift_normalization.md` |
...
| H196 | CLOSED | Rhode Island Keno active-promo upper bound | 109.649% | `research/h196_ri_keno_buy2_get1_upper_bound.md` |
| H197 | CLOSED | Rhode Island first-deposit-match Keno bound | 109.649% | `research/h197_ri_first_deposit_match_keno_bound.md` |
| H198 | CLOSED | RI doubler multi-game semantics and Kick Back recovery | — | `research/h198_ri_doubler_multigame_semantics_and_kickback_recovery.md` |
| H199 | CLOSED | RI Keno ticket-price semantics and execution bound | — | `research/h199_ri_keno_ticket_price_semantics_and_execution_bound.md` |
| H200 | CLOSED | RI Keno cart execution and operator-limit gate | — | `research/h200_ri_keno_cart_execution_and_operator_limit_gate.md` |
| H201 | CLOSED | RI Keno parallel-account execution gate | — | `research/h201_ri_keno_parallel_account_execution_gate.md` |
| H202 | OPEN | Rhode Island `Kick Back with Keno` promotion attribution gate | — | `research/h202_ri_kick_back_promo_attribution_gate.md` |
| H203 | CLOSED | Rhode Island Keno group-play and retailer batch gate | — | `research/h203_ri_keno_group_play_and_retailer_batch_gate.md` |
| H204 | CLOSED | Rhode Island app-generated QR retail execution gate | — | `research/h204_ri_app_qr_retail_execution_gate.md` |
| H205 | CLOSED | Rhode Island Registered Ticketless Play execution bound | — | `research/h205_ri_registered_ticketless_play_execution_bound.md` |
| H206 | CLOSED | Rhode Island iLottery cart batching and purchase-limit gate | — | `research/h206_ri_ilottery_cart_and_purchase_limit_gate.md` |
| H207 | CLOSED | Rhode Island iLottery strict-execution impossibility | — | `research/h207_ri_ilottery_strict_execution_impossibility.md` |
...
| H219 | CLOSED | vectorized exact H175 shard screen | — | `research/h219_vectorized_exact_h175_shards.md` |
...
| H232 | CLOSED | 44-way chunked exact sector CSP | — | `research/h232_chunked_sector_exact_shift_csp.md` |
...
| H241 | CLOSED | Missouri Club Keno Bulls-Eye / Double Bulls-Eye Bonus Hours full-coverage upper-bound closure | 50% | `research/h241_missouri_bullseye_bonus_hours_full_coverage.md` |
| H242 | CLOSED | Michigan Club Keno Tripler Time: random-entitlement guarantee gate | — | `research/h242_michigan_tripler_time_random_entitlement_gate.md` |
| H243 | CLOSED | Illinois Pick 3 / Pick 4 plus FIREBALL full-coverage upper bound | — | `research/h243_illinois_plus_fireball_full_coverage_upper_bound.md` |
| H244 | CLOSED | WinTrillions 90% Powerball promotion guarantee gate | — | `research/h244_wintrillions_90pct_powerball_promo_guarantee_gate.md` |
| H245 | CLOSED | UK Lotto two-round full-space closure | — | `research/h245_uk_lotto_two_round_full_space_closure.md` |
| H246 | CLOSED | LOTTO 6/49 SuperDraw 2026 full-coverage closure | 46.5456% | `research/h246_lotto649_superdraw_full_coverage_closure.md` |
...
| H251 | CLOSED | Irish Lotto 6/45 Lotto Plus full-cover additive closure | 52.8477% | `research/h251_irish_lotto_45_plus_full_cover.md` |
| H252 | CLOSED | Irish Lotto 6/45 cap full-cover sharing gate | — | `research/h252_irish_lotto_45_cap_full_cover_sharing_gate.md` |
| H253 | CLOSED | Georgia scratcher endgame inventory gate | 198.899% | `research/h253_georgia_scratcher_endgame_inventory_gate.md` |
| H254 | CLOSED | Irish guaranteed-raffle capture screen | — | `research/h254_irish_guaranteed_raffle_capture_screen.md` |
| H255 | CLOSED | UK Lotto lower-tier boost covering-design impossibility | 62.4667% | `research/h255_uk_lotto_match3_boost_impossibility.md` |
...
| H259 | CLOSED | fixed pull-tab pack buyout screen | 62.8571% | `research/h259_fixed_pulltab_pack_buyout_screen.md` |
...
| H262 | CLOSED | LOTTO 6/49 final Gold Ball takeover screen | — | `research/h262_lotto649_final_gold_ball_takeover.md` |
...
| H319 | CLOSED | Giveaway Guys 20% subscription-credit finite-pool bound | 84.8485% | `research/H319_STATUS.md` |
...
| H333 | UNCLASSIFIED | H333_STATUS | — | `research/H333_STATUS.md` |
| H334 | CLOSED | H334_STATUS | — | `research/H334_STATUS.md` |
| H335 | CLOSED | H335_STATUS | — | `research/H335_STATUS.md` |
| H336 | CLOSED | H336_STATUS | — | `research/H336_STATUS.md` |
| H337 | CLOSED | H337_STATUS | — | `research/H337_STATUS.md` |
| H338 | CLOSED | H338_STATUS | — | `research/H338_STATUS.md` |
| H339 | CLOSED | H339_STATUS | — | `research/H339_STATUS.md` |
| H340 | CLOSED | H340_STATUS | — | `research/H340_STATUS.md` |
| H341 | CLOSED | H341_STATUS | — | `research/H341_STATUS.md` |
| H342 | CLOSED | H342_STATUS | — | `research/H342_STATUS.md` |
| H343 | CLOSED | H343_STATUS | — | `research/H343_STATUS.md` |
| H344 | CLOSED | H344_STATUS | — | `research/H344_STATUS.md` |
| H345 | CLOSED | H345_STATUS | — | `research/H345_STATUS.md` |
| H346 | CLOSED | H346_STATUS | — | `research/H346_STATUS.md` |
| H347 | CLOSED | H347_STATUS | 52.8815% | `research/H347_STATUS.md` |
| H348 | CLOSED | H348_STATUS | 20.0167% | `research/H348_STATUS.md` |
| H349 | CLOSED | H349_STATUS | 114.168% | `research/H349_STATUS.md` |
| H350 | CLOSED | H350_STATUS | 5% | `research/H350_STATUS.md` |
| H351 | CLOSED | H351_STATUS | — | `research/H351_STATUS.md` |
| H352 | CLOSED | Enable Lottery / Gatherwell additive Super Draw | — | `research/H352_STATUS.md` |
| H353 | CLOSED | H353_STATUS | 109.657% | `research/H353_STATUS.md` |
| H354 | CLOSED | H354_STATUS | 70% | `research/H354_STATUS.md` |
| H355 | CLOSED | H355_STATUS | 52.0007% | `research/H355_STATUS.md` |
| H356 | CLOSED | H356_STATUS | 26.9009% | `research/H356_STATUS.md` |
| H357 | CLOSED | H357_STATUS | — | `research/H357_STATUS.md` |
