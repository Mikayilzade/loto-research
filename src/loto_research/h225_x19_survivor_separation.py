...
base.OLD=base.OLD+[
 ...
 (ROOT/'data'/'derived'/'h225_x17_new_witnesses.json','H225-X17'),
]
...
def load_x18():
 ...
 return d
base.load_x8=load_x18

def relabel_job(out):
 out['packet']='H225-X19'; out['source_packet']='H225-X18'
 if 'x8_chunk_survivor_states' in out: out['x18_chunk_survivor_states']=out.pop('x8_chunk_survivor_states')
 if 'x8_chunk_survivor_shift_tuples' in out: out['x18_chunk_survivor_shift_tuples']=out.pop('x8_chunk_survivor_shift_tuples')
 return out
