...
## Current stage
**Stage 1 — structural/state-edge search; H057 irrevocably-vested cash reward screen completed**
...
Files:
- `research/h057_irrevocable_cash_reward_screen.md`
- `data/derived/h057_current_reward_screen.csv`

## Current result
Fresh 2026 screen covered:
- Payoneer Prestige Club and BLS cash-reward mechanisms;
- IBKR self-controlled onboarding rewards;
- Freedom24 WELCOME funding promotion;
- Azerbaijan XalqKart 7% balance return;
- Mastercard Qazanç+ Azerbaijan;
- Bank Respublika NeoCard welcome bonuses;
- targeted ABB fixed-cashback controls.

### What survived
Real fixed-cash/cashback mechanisms clearly exist, including Payoneer business-volume rewards and local Azerbaijan cashback programs.

### Why no H057 SUCCESS
No current candidate simultaneously proves all of:
1. public Azerbaijan eligibility;
2. no invitation/first-N/discretionary selection;
3. fully user-controlled qualifying action;
4. recoverable cash principal;
5. fixed positive cash reward;
6. deterministic vesting;
7. survival of cancellation/clawback/insolvency branches;
8. positive net cash after all fees/tax/FX.

Key current controls:
- **Payoneer Prestige Club 2026**: real cashback, but invite-only and private target/reward setup.
- **Freedom24 WELCOME through 31 Aug 2026**: self-funded reward is gift shares; value fluctuates and sale incurs fees.
- **XalqKart**: current free card + 7% annual return on 300–20,000 AZN balances through 31 Dec 2026, but reward accrues over time and fails the already-proved H051 immediate-adverse-event terminal gate.
- **Mastercard Qazanç+**: current Azerbaijan cashback up to 16%, but generated by consumption spending rather than preserved qualifying principal.

H057 status: **CURRENT LANDSCAPE NARROWED; NO TERMINAL GUARANTEE**.

# H056 — geography-compatible fixed-cash referral lead
IBKR remains a strong conditional cash lead:
- Azerbaijan platform access explicit;
- flat USD 200 referrer reward;
- referred client must deposit/maintain USD 10,000 for one year.

Still not SUCCESS because program amendment/termination, anti-abuse/jurisdictional discretion and independent third-party dependency remain.
...
- AZN; minimum 500 AZN; 12/18/24 months;
- interest paid in advance;
- current rates 9.50% / 9.00% / 9.00%;
- official page says deposit amount is insured.

### VTB Azerbaijan — Avans
- AZN; minimum 500 AZN; 12–36 months;
...
- H020 two-sided arbitrage: mechanism validated; no vested subsidy/current live terminal setup.
...
# Next priorities
1. **H058: business-volume/payment-rail rebate scan** — public Azerbaijan-compatible programs where a fixed cash rebate attaches to genuine independently owed business receipts/transfers, avoiding the retail-consumption principal problem.
2. Search public payment-provider campaigns with explicit reward/threshold and no invitation/private targeting.
3. Search regulated cross-border providers for self-controlled transfer/funding cash credits with deterministic vesting.
