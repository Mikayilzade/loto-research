...
The recovered baseline contained 150 draws through 2026-06-21. Subsequent collection recovered 44 validated draws covering 2026-07-10 through 2026-08-22. This run added **1 more validated draw** for **2026-08-23** from Magayo. The page renders the latest result as 20 ball images; each ball link URL encodes the actual value in query parameter `p2`, allowing the complete result to be recovered without OCR: `5,10,11,14,19,28,32,35,36,42,47,48,49,51,53,54,64,65,69,70`.
...
Close **2026-06-22 to 2026-07-09**, then move backward into older gaps. Keep provenance and deduplicate by date, official draw number, and sorted 20-number combination.
